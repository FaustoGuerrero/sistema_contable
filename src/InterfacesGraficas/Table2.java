...
public class Table2 extends javax.swing.JDialog {

    JTable table;
    DefaultTableModel dm;

    public Table2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        JLabel columna0[] = new JLabel[8];
        columna0[0] = new JLabel("<html><body>Выручка от продаж</body></html>");
        columna0[1] = new JLabel("<html><body>Прибыль от продаж</body></html>");
        columna0[2] = new JLabel("<html><body>Прибыль до<br>налогообложения</body></html>");
        columna0[3] = new JLabel("<html><body>Чистая прибыль</body></html>");
        columna0[4] = new JLabel("<html><body>Себестоимость проданной<br>продукции, работ, услуг</body></html>");
        columna0[5] = new JLabel("<html><body>Рентабельность продаж, Pпродаж.</body></html>");
        columna0[6] = new JLabel("<html><body>Чистая рентабельность, Pч.</body></html>");
        columna0[7] = new JLabel("<html><body>Рентабельность продукции,<br>Pпродукции.</body></html>");
   
        String[] pokazateli = new String[]{"n02010", "n02050", "n02140", "n02190", "n02020"};
        ...
        for (int j = 1; j < 4; j++) {
            division = Double.valueOf(valores[1][j].toString()) / Double.valueOf(valores[0][j].toString());
        ...
        for (int j = 1; j < 4; j++) {
            division = Double.valueOf(valores[3][j].toString()) / Double.valueOf(valores[0][j].toString());            
            rounded = new BigDecimal(division);
            rounded = rounded.setScale(2, BigDecimal.ROUND_HALF_UP);
            valores[6][j] = rounded;
        }
        
        String[] pok2 = new String[]{"n02020","n02030", "n02040"};        
        tab.llenarDatos(pok2, pok2.length, 3);
        //Рентабельность продукции  
        int suma;
        for (int j = 1; j < 4; j++) {
            suma = tab.datos[0][j-1] + tab.datos[1][j-1] + tab.datos[2][j-1];
            division = Double.valueOf(valores[1][j].toString()) / suma;
            rounded = new BigDecimal(division);
            rounded = rounded.setScale(2, BigDecimal.ROUND_HALF_UP);
            valores[7][j] = rounded;
        }
        ...
        jLabel3.setIcon(new GrafikBarChart3D(this.jLabel3.getSize(), valores));        
    }

    private void printTable() {
        MessageFormat header = new MessageFormat("Обобщающие показатели экономической эффективности организации\n");
...
//        table.getColumnModel().getColumn(6).setCellRenderer(derecha);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Обобщающие показатели экономической эффективности организации");
        jLabel2.setOpaque(true);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1590, 60));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 480, 250, 70));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 480, 250, 70));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 560, 80, 20));

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 80, 700, 370));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Table2 dialog = new Table2(new javax.swing.JFrame(), true);
