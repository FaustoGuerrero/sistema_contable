...
public class Table3 extends javax.swing.JDialog {
    ...
    public Table3(java.awt.Frame parent, boolean modal) {
        ...
        JLabel columna0[] = new JLabel[7];
        columna0[0] = new JLabel("<html><body>Чистая прибыль</body></html>");
        columna0[1] = new JLabel("<html><body>Средняя стоимость активов</body></html>");
        columna0[2] = new JLabel("<html><body>Средняя стоимость оборотных <br>активов</body></html>");
        columna0[3] = new JLabel("<html><body>Средняя стоимость машин<br>и оборудования</body></html>");
        columna0[4] = new JLabel("<html><body>Рентабельность активов</body></html>");
        columna0[5] = new JLabel("<html><body>Рентабельность оборотных <br>активов, Pоа</body></html>");
        columna0[6] = new JLabel("<html><body>Рентабельность машин и<br>оборудования, Pмо</body></html>");

        String[] pokazateli = new String[]{"n02190", "n01300", "n01290", "n05090"};
        ...
        //Рентабельность машин        
        for (int j = 1; j < 4; j++) {
            division = Double.valueOf(valores[0][j].toString()) / Double.valueOf(valores[3][j].toString());
            rounded = new BigDecimal(division);
            rounded = rounded.setScale(2, BigDecimal.ROUND_HALF_UP);
            valores[6][j] = rounded;
        }
    ...
    private void printTable() {
        MessageFormat header = new MessageFormat("Показатели экономической эффективности использования активов\n");
...
//        table.getColumnModel().getColumn(6).setCellRenderer(derecha);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Показатели экономической эффективности использования активов ");
